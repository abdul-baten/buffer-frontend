import { I_INS_BASE, I_INS_CHART } from './insight.model';
...
// tslint:disable-next-line
export interface I_FB_OVERVIEW extends I_INS_BASE {
...
// tslint:disable-next-line
export interface I_FB_VIDEOS extends I_INS_BASE {
