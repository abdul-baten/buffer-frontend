...
export class LoggerService {
  private error_occured_date = dayJs().toISOString();
  ...
  public logUiError (main_error: Error, error_component: string, error_line_number: string, error_column_number: string): void {
    ...
    const error_object: IUiError = {
      ...
      error_line_number,
      error_message,
      error_time: this.error_occured_date,
      error_url
    };

    error('[ERROR]', this.error_occured_date, error_message, error_object);
  }
